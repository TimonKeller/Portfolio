    ...
    <div className='container mx-auto mb-8 px-10 md:px-0'>
      ...
      <div className='flex flex-col md:shadow-md md:shadow-black md:rounded-md mt-16 md:mt-24'>
        ...
        <div className='md:px-20  mt-10 md:mt-20'>
          <h1 className='text-center md:text-start font-caveat text-orange dark:text-blue text-5xl md:text-6xl mb-10'>Lead Tool</h1>
          ...
          <div className='flex flex-col-reverse md:flex-row gap-x-10 justify-center'>
            <ul className='self-center'>
              <h1 className='text-center md:text-start text-orange dark:text-blue text-3xl mb-10'>
                The Solution
              </h1>
              <ul className='mt-10 list-decimal marker:text-orange dark:text-blue marker:font-caveat marker:text-2xl px-4'>
